...
function Parallax() {
  ...
  return (
    <section className="parallax">
      <img
        src="/kennythaitea/hill1.png"
        id="hill1"
        ref={hill1Ref}
        alt="hill1"
      />
      <img
        src="/kennythaitea/hill2.png"
        id="hill2"
        ref={hill2Ref}
        alt="hill2"
      />
      <img
        src="/kennythaitea/hill3.png"
        id="hill3"
        ref={hill3Ref}
        alt="hill3"
      />
      <img
        src="/kennythaitea/hill4.png"
        id="hill4"
        ref={hill4Ref}
        alt="hill4"
      />
      <img
        src="/kennythaitea/hill5.png"
        id="hill5"
        ref={hill5Ref}
        alt="hill5"
      />
      <img src="/kennythaitea/tree.png" id="tree" ref={treeRef} alt="tree1" />
      <h2 id="text" ref={textRef}>
        Hello World!
      </h2>
      <img src="/kennythaitea/leaf.png" id="leaf" ref={leafRef} alt="leaf" />
      <img
        src="/kennythaitea/plant.png"
        id="plant"
        ref={plantRef}
        alt="plant"
      />
